...
CREATE INDEX "prices_lat_lng_idx" ON "prices" ("latitude", "longitude");
...
CREATE INDEX "safety_reports_lat_lng_idx" ON "safety_reports" ("latitude", "longitude");

-- 3. 插入物价种子数据（成都春熙路附近）
INSERT INTO "prices" ("id", "product", "unit", "price", "store_name", "latitude", "longitude", "created_at", "updated_at") VALUES
...
-- 4. 插入安全预警种子数据
INSERT INTO "safety_reports" ("id", "event_type", "description", "latitude", "longitude", "reported_at") VALUES
...
-- 5. 验证
SELECT COUNT(*) AS "物价记录数" FROM "prices";
SELECT COUNT(*) AS "安全预警数" FROM "safety_reports";
